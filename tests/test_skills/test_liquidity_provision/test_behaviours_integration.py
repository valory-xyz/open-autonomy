...
class TestLiquidityProvisionHardhat(
    ...
    def setup(cls, **kwargs: Any) -> None:
        ...
        cls.multisend_data_exit = ""
        ...
        cls.most_voted_tx_hash_exit = (
            "4fe07ef17e89a6106da11c222d94ebdb320a14f707111bec2c78f3cc2e369343"
        )
    ...
    def test_exit_pool_tx_hash_behaviour(self) -> None:
        ...
        period_state = cast(
            PeriodState,
            self.default_period_state_exit.update(
                most_voted_strategy=strategy, most_voted_lp_result=1
            ),
        )
