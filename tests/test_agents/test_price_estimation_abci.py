...
CHECK_STRINGS = (
    ...
    "Entered in the 'randomness_a_startup' round for period 0",
    "'randomness_a_startup' round is done",
    ...
    "Entered in the 'randomness_b_startup' round for period 0",
    "'randomness_b_startup' round is done",
    "Entered in the 'select_keeper_b_startup' round for period 0",
    "'select_keeper_b_startup' round is done",
