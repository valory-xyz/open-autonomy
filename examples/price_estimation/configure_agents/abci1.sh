...
aea config set vendor.valory.skills.price_estimation_abci.models.price_api.args.headers '[["Accepts","application/json"], ["X-CMC_PRO_API_KEY","2142662b-985c-4862-82d7-e91457850c2a"]]'  --type list
...
aea config set vendor.valory.connections.ledger.config.retry_timeout 3 --type int
aea build
