...
Ensure accurate configuration, in paricular, swap folder names of `configure_agents` and `configure_agents_ropsten`. Then run `make localnet-start` from within the node: `ssh root@178.62.4.138`
