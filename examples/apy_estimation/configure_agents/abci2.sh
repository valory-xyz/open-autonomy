...
aea config set vendor.valory.skills.apy_estimation_abci.models.randomness_api.args.url https://api2.drand.sh/public/latest
aea config set vendor.valory.skills.apy_estimation_abci.models.randomness_api.args.api_id protocollabs2
...
aea config set vendor.valory.skills.apy_estimation_abci.models.params.args.tendermint_url "http://node2:26657"
