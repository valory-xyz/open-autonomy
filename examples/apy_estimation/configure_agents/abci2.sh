...
aea config set vendor.valory.skills.apy_estimation.models.randomness_api.args.url https://api2.drand.sh/public/latest
aea config set vendor.valory.skills.apy_estimation.models.randomness_api.args.api_id protocollabs2
...
aea config set vendor.valory.skills.apy_estimation.models.params.args.tendermint_url "http://node2:26657"
