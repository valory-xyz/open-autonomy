...
aea config set vendor.valory.skills.apy_estimation.models.randomness_api.args.url https://drand.cloudflare.com/public/latest
aea config set vendor.valory.skills.apy_estimation.models.randomness_api.args.api_id cloudflare
...
aea config set vendor.valory.skills.apy_estimation.models.params.args.tendermint_url "http://node0:26657"
...
aea config set vendor.valory.skills.apy_estimation.models.params.args.optimizer.n_trials 10 --type int
aea config set vendor.valory.skills.apy_estimation.models.params.args.optimizer.timeout None
aea config set vendor.valory.skills.apy_estimation.models.params.args.optimizer.n_jobs 1 --type int
aea config set vendor.valory.skills.apy_estimation.models.params.args.optimizer.show_progress_bar false
aea config set vendor.valory.skills.apy_estimation.models.params.args.optimizer.scoring pinball
aea config set vendor.valory.skills.apy_estimation.models.params.args.optimizer.alpha 0.25
aea config set vendor.valory.skills.apy_estimation.models.params.args.pair_id 0x2b4c76d0dc16be1c31d4c1dc53bf9b45987fc75c
aea config set vendor.valory.skills.apy_estimation.models.params.args.sleep_time 10
aea build
