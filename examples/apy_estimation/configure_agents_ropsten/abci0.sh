...
aea config set vendor.valory.connections.abci.config.host "abci1"
...
aea config set vendor.valory.skills.apy_estimation_abci.models.randomness_api.args.url https://drand.cloudflare.com/public/latest
aea config set vendor.valory.skills.apy_estimation_abci.models.randomness_api.args.api_id cloudflare
