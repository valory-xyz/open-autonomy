...
aea config set vendor.valory.skills.apy_estimation.models.randomness_api.args.url https://api3.drand.sh/public/latest
aea config set vendor.valory.skills.apy_estimation.models.randomness_api.args.api_id protocollabs3
...
aea config set vendor.valory.skills.apy_estimation.models.params.args.tendermint_url "http://node3:26657"
