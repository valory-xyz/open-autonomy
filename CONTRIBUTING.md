...
You can find several general recommendations in the **Considerations to Develop FSM Apps** section in our documentation [here](https://davidminarsch.github.io/temp-docs-valory/fsm_app_introduction/).