...
def get_all_extras() -> Dict:
    ...
    cli_deps = [
        "click==8.0.2",
        "open-aea-cli-ipfs==1.27.0.post4",
    ]
...
base_deps = [
    "Flask>=2.0.2,<3.0.0",
    "open-aea[all]==1.27.0.post1",
    "pandas<1.4,>=1.3.4",
    "watchdog >=2.1.6",
    "pytest==7.0.0",
    "open-aea-ledger-ethereum==1.27.0",
...
if __name__ == "__main__":
    setup(
        ...
        package_data={
            ...
            "packages": [
                "valory/contracts/component_registry/*",
                "valory/contracts/registries_manager/*",
            ],
        },
