...
cp ../configure_agents/keys/ethereum_private_key_5.txt ethereum_private_key.txt
...
aea config set vendor.valory.skills.price_estimation_abci.models.params.args.tendermint_url http://node5:26657
