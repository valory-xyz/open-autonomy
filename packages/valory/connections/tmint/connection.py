...
"""HTTP client connection and channel for Tendermint Healthcheck."""
import asyncio
import email
import logging
import ssl
...
REQUEST_TIMEOUT = 408
SERVER_ERROR = 500
PUBLIC_ID = PublicId.from_str("valory/tmint:0.1.0")
...
class HttpDialogues(BaseHttpDialogues):
    ...
    def __init__(self) -> None:
        ...
        BaseHttpDialogues.__init__(
            self,
            self_address=str(TendermintHTTPClientConnection.connection_id),
            role_from_first_message=role_from_first_message,
            dialogue_class=HttpDialogue,
        )


class TendermintHTTPClientAsyncChannel:
    ...
    async def _perform_http_request(
        ...
        while True:
            try:
                ...
                self.logger.info("Tendermint not running, Trying again !")
                time.sleep(1)
...
class TendermintHTTPClientConnection(Connection):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.channel = TendermintHTTPClientAsyncChannel(
