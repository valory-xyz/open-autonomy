...
class GatherPayload(BaseTxPayload):
    """Represent a transaction payload of type 'gather'."""

    transaction_type = TransactionType.GATHER

    def __init__(self, sender: str, vote: Optional[bool] = None, **kwargs: Any) -> None:
        """Initialize a 'gather' transaction payload.
