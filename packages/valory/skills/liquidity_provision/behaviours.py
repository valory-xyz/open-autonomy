...
import pprint
from abc import ABC
from typing import Generator, Set, Type, cast, Mapping
...
class TransactionSendBaseBehaviour(LiquidityProvisionBaseBehaviour):
    ...
    participants = {} # type: Mapping[str, ValidatePayload]
...
class SwapValidationBehaviour(TransactionValidationBaseBehaviour):
    ...
    def __init__(self) -> None:
        ...
        self.participants = self.period_state._participant_to_swap_validation
        self.data = {}
        super().__init__()
...
class AddAllowanceValidationBehaviour(TransactionValidationBaseBehaviour):
    ...
    def __init__(self) -> None:
        ...
        self.participants = self.period_state._participant_to_add_allowance_validation
        self.data = {}
        super().__init__()
...
class AddLiquidityValidationBehaviour(TransactionValidationBaseBehaviour):
    ...
    def __init__(self) -> None:
        ...
        self.participants = self.period_state._participant_to_add_liquidity_validation
        self.data = {}
        super().__init__()
...
class RemoveLiquidityValidationBehaviour(TransactionValidationBaseBehaviour):
    ...
    def __init__(self) -> None:
        ...
        self.participants = (
            self.period_state._participant_to_remove_liquidity_validation
        )
        self.data = {}
        super().__init__()
...
class RemoveAllowanceValidationBehaviour(TransactionValidationBaseBehaviour):
    ...
    def __init__(self) -> None:
        ...
        self.participants = (
            self.period_state._participant_to_remove_allowance_validation
        )
        self.data = {}
        super().__init__()
...
class SwapBackValidationBehaviour(TransactionValidationBaseBehaviour):
    ...
    def __init__(self) -> None:
        ...
        self.participants = self.period_state._participant_to_swap_back_validation
        self.data = {}
        super().__init__()
