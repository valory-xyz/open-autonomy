...
class PeriodState(BasePeriodState):  # pylint: disable=too-many-instance-attributes,too-many-statements,too-many-public-methods
    """
    ...
    def __init__(  # pylint: disable=too-many-arguments,too-many-locals,too-many-statements
        ...
        participant_to_swap_signature: Optional[
            Mapping[str, StrategyEvaluationPayload]
        ] = None,
...
class SwapSendRound(TransactionHashBaseRound):
