...
_default_logger = logging.getLogger(
    "aea.packages.valory.protocols.state_update.message"
)
...
class StateUpdateMessage(Message):
    ...
    protocol_id = PublicId.from_str("valory/state_update:1.0.0")
    protocol_specification_id = PublicId.from_str("valory/state_update:1.0.0")
