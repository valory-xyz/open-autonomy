...
[the Protobuf file `types.proto` for the ABCI protocol](https://github.com/tendermint/tendermint/blob/v0.35.7/proto/tendermint/abci/types.proto).
...
speech_acts:
  # https://github.com/tendermint/tendermint/blob/v0.35.7/proto/tendermint/abci/types.proto#L41
  request_echo:
    message: pt:str
  # https://github.com/tendermint/tendermint/blob/v0.35.7/proto/tendermint/abci/types.proto#L45
  request_flush: {}
  # https://github.com/tendermint/tendermint/blob/v0.35.7/proto/tendermint/abci/types.proto#L47
  request_info:
    version: pt:str
    block_version: pt:int
    p2p_version: pt:int
    abci_version: pt:str
  # https://github.com/tendermint/tendermint/blob/v0.35.7/proto/tendermint/abci/types.proto#L54
  request_init_chain:
    time: ct:Timestamp
    chain_id: pt:str
  ...
  # https://github.com/tendermint/tendermint/blob/v0.35.7/proto/tendermint/abci/types.proto#L63
  request_query:
    query_data: pt:bytes
    path: pt:str
    height: pt:int
    prove: pt:bool
  # https://github.com/tendermint/tendermint/blob/v0.35.7/proto/tendermint/abci/types.proto#L70
  request_begin_block:
    hash: pt:bytes
    header: ct:Header
    last_commit_info: ct:LastCommitInfo
    byzantine_validators: ct:Evidences
  # https://github.com/tendermint/tendermint/blob/v0.35.7/proto/tendermint/abci/types.proto#L82
  request_check_tx:
    tx: pt:bytes
    type: ct:CheckTxType   
  # https://github.com/tendermint/tendermint/blob/v0.35.7/proto/tendermint/abci/types.proto#L87
  request_deliver_tx:
    tx: pt:bytes
  # https://github.com/tendermint/tendermint/blob/v0.35.7/proto/tendermint/abci/types.proto#L91
  request_end_block:
    height: pt:int
  # https://github.com/tendermint/tendermint/blob/v0.35.7/proto/tendermint/abci/types.proto#L95
  request_commit: {}
  # https://github.com/tendermint/tendermint/blob/v0.35.7/proto/tendermint/abci/types.proto#L98
  request_list_snapshots: {}
  # https://github.com/tendermint/tendermint/blob/v0.35.7/proto/tendermint/abci/types.proto#L101
  ...
  # https://github.com/tendermint/tendermint/blob/v0.35.7/proto/tendermint/abci/types.proto#L107
  request_load_snapshot_chunk:
    height: pt:int
    format: pt:int
    chunk_index: pt:int
  # https://github.com/tendermint/tendermint/blob/v0.35.7/proto/tendermint/abci/types.proto#L115
  request_apply_snapshot_chunk:
    index: pt:int
    chunk: pt:bytes
    chunk_sender: pt:str  # 'sender' conflicts with the attribute of 'Message'
  # https://github.com/tendermint/tendermint/blob/v0.35.7/proto/tendermint/abci/types.proto#L144
  response_exception: {
    error: pt:str
  }
  # https://github.com/tendermint/tendermint/blob/v0.35.7/proto/tendermint/abci/types.proto#L148
  response_echo:
    message: pt:str
  # https://github.com/tendermint/tendermint/blob/v0.35.7/proto/tendermint/abci/types.proto#L152
  response_flush: {}
  # https://github.com/tendermint/tendermint/blob/v0.35.7/proto/tendermint/abci/types.proto#L154
  response_info:
    info_data: pt:str
    version: pt:str
    app_version: pt:int
  ...
  # https://github.com/tendermint/tendermint/blob/v0.35.7/proto/tendermint/abci/types.proto#L165
  response_init_chain:
    consensus_params: pt:optional[ct:ConsensusParams]
    validators: ct:ValidatorUpdates      
    app_hash: pt:bytes
  # https://github.com/tendermint/tendermint/blob/v0.35.7/proto/tendermint/abci/types.proto#L171
  response_query:
    code: pt:int
    log: pt:str
    info: pt:str
    ...
    height: pt:int
    codespace: pt:str
  # https://github.com/tendermint/tendermint/blob/v0.35.7/proto/tendermint/abci/types.proto#L184
  response_begin_block:
    events: ct:Events
  # https://github.com/tendermint/tendermint/blob/v0.35.7/proto/tendermint/abci/types.proto#L188
  response_check_tx:
    code: pt:int
    data: pt:bytes
    log: pt:str
  ...
  response_deliver_tx:
    ...
    events: ct:Events
    codespace: pt:str
  # https://github.com/tendermint/tendermint/blob/v0.35.7/proto/tendermint/abci/types.proto#L217
  response_end_block:
    validator_updates: ct:ValidatorUpdates
    consensus_param_updates: pt:optional[ct:ConsensusParams]
    events: ct:Events
  # https://github.com/tendermint/tendermint/blob/v0.35.7/proto/tendermint/abci/types.proto#L223
  response_commit:
    data: pt:bytes
    retain_height: pt:int
  # https://github.com/tendermint/tendermint/blob/v0.35.7/proto/tendermint/abci/types.proto#L229
  response_list_snapshots:
    snapshots: ct:SnapShots
  # https://github.com/tendermint/tendermint/blob/v0.35.7/proto/tendermint/abci/types.proto#L233
  response_offer_snapshot:
    result: ct:Result
  # https://github.com/tendermint/tendermint/blob/v0.35.7/proto/tendermint/abci/types.proto#L246
  response_load_snapshot_chunk:
    chunk: pt:bytes
  # https://github.com/tendermint/tendermint/blob/v0.35.7/proto/tendermint/abci/types.proto#L250
...
# https://github.com/tendermint/tendermint/blob/v0.35.7/proto/tendermint/types/types.proto#L58
ct:Header: |
