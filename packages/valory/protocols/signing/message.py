...
from packages.valory.protocols.signing.custom_types import ErrorCode as CustomErrorCode
...
from packages.valory.protocols.signing.custom_types import Terms as CustomTerms


_default_logger = logging.getLogger("aea.packages.valory.protocols.signing.message")
...
class SigningMessage(Message):
    ...
    protocol_id = PublicId.from_str("valory/signing:1.0.0")
    protocol_specification_id = PublicId.from_str("valory/signing:1.0.0")
