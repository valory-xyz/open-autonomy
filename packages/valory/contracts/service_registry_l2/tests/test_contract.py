...
class BaseServiceRegistryL2ContractTest(BaseRegistriesContractsTest):
    """Base class for Service Registry contract tests"""

    contract: ServiceRegistryL2Contract
...
@skip_docker_tests
class TestServiceRegistryL2Contract(BaseServiceRegistryL2ContractTest):
