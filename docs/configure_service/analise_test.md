...
???+ example
    ...
    ```bash
    autonomy fetch bafybeigspppd7guihobwrhorhht3i47j4qa56tixnicgwtepfeoou54vju
...
The framework also provides CLI tools for building and running [local testing deployments](../guides/deploy_service/index.md#local-deployment).
