...
```json
{
    ...
    "third_party": {
        ...
        "contract/valory/service_registry/0.1.0": "bafybeicmmcpdhf76sscpywfbplps4vll2dzgwprgr733xoonmha2ojnwey",
        ...
        "skill/valory/abstract_round_abci/0.1.0": "bafybeihgeonrdidopzftbhwqudj4qs7mfdmczpxeqtzyelteo6ehwlij5e",
