...
We will show how to use the CLI to run a local deployment of the [Hello World service](https://docs.autonolas.network/demo/hello-world/), which comprises:
...
4. Run the service:
    ...
    This will deploy the [Hello World service](https://docs.autonolas.network/demo/hello-world/) locally with four agents connected to four Tendermint nodes.
