...
You can mint packages using the [Autonolas Protocol web app](https://protocol.autonolas.network/) or using the Open Autonomy CLI.
...
5. **Explore the protocol using the web app.** Use the [Autonolas Protocol web app](https://protocol.autonolas.network/) to explore the packages that you have minted. Ensure that you are connected to the local  blockchain configured in Step 2 above through Metamask.
