...
if the _syncing_up flag is set to true, the `async_act` method won't be executed
instead `wait_until_round` will be executed directly. For more details refer to
