<a id="packages.valory.skills.abstract_round_abci.tests.test_abci_app_chain"></a>
...
<a id="packages.valory.skills.abstract_round_abci.tests.test_abci_app_chain.TestAbciAppChaining.setup_method"></a>
...
<a id="packages.valory.skills.abstract_round_abci.tests.test_abci_app_chain.TestAbciAppChaining.test_synchronized_data_type"></a>

#### test`_`synchronized`_`data`_`type
...
<a id="packages.valory.skills.abstract_round_abci.tests.test_abci_app_chain.TestAbciAppChaining.test_precondition_for_next_app_missing_raises"></a>

#### test`_`precondition`_`for`_`next`_`app`_`missing`_`raises
...
<a id="packages.valory.skills.abstract_round_abci.tests.test_abci_app_chain.TestAbciAppChaining.test_precondition_app_missing_raises"></a>

#### test`_`precondition`_`app`_`missing`_`raises
