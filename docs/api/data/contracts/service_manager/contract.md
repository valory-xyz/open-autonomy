...
<a id="autonomy.data.contracts.service_manager.contract.ServiceManagerContract.load_service_manager_abi"></a>

#### load`_`service`_`manager`_`abi
...
<a id="autonomy.data.contracts.service_manager.contract.ServiceManagerContract.is_service_manager_token_compatible_chain"></a>
...
<a id="autonomy.data.contracts.service_manager.contract.ServiceManagerContract.get_events"></a>
