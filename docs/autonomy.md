...
To create an environment you'll need a service id and a file containing keys with funds for the chain you want to use. The necessary images will be build during the build process.
