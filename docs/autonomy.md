...
This will create and image with label `valory/consensus-algorithms-open-aea:oracle-0.1.0`. Images generated by this command will follow `valory/consensus-algorithms-open-aea:app_name-version` format for labels.
