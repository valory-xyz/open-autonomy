...
```bash
# fetch a service
$ autonomy fetch --service valory/oracle_hardhat:0.1.0:bafybeickr6gqcnnpponprryxezx4kszmk4iyeaqtadxrw7t3u52zkh5frm
$ cd oracle_hardhat
...
```bash
# To build an image, navigate to the service dir and run
$ autonomy build-image --agent valory/oracle:bafybeiey2o5yktbiitmyfpbe2f4cntmjg2wyml6wbsu4ldh2vw5vdlusru
```
