...
2. Use the CLI to download the `valory/counter` service.
    ```bash
    autonomy fetch valory/counter:0.1.0:bafybeib6nowjvduuckd4qw4v7ta6dfpiuqe7yyqhoe5tzrhvegiqjztete --remote --service
    cd counter
    ```
...
```bash
autonomy fetch valory/counter_client:0.1.0:bafybeicypnm3di4jlcgbjnkp5dkio22a6ypognilnrc52hzrfg5ii42euy --remote
```
