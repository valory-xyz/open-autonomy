...
[Tendermint project](https://docs.cosmos.network/v0.47/tendermint/introduction) (now part of Cosmos). Nevertheless,
an ABCI App can work with any consensus engine
that is ABCI-compatible, e.g., [Sonic](https://docs.soniclabs.com/) (formerly Fantom).
In the remaining of this section, we will consider [CometBFT](https://docs.cometbft.com/) (formerly Tendermint) as the consensus engine.
...
See also the [Protobuf definitions](https://github.com/cometbft/cometbft/blob/main/proto/tendermint/abci/types.proto) of those messages. The application can send a transaction by using the following
